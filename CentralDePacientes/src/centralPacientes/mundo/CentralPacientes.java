...
-
    ...
    int numerosHombres = 0;

        for (Paciente paciente : darPacientes())

            if (paciente.darSexo() == Paciente.HOMBRE) numerosHombres++;

        return numerosHombres;
}
    public int cantMujeres() {
        ...
        for (Paciente paciente : darPacientes())
            ...
            if (paciente.darSexo() == Paciente.MUJER) numerosMujeres++;

        return numerosMujeres;
    }
